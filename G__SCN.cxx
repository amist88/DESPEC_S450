...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<array<unsigned long,4> >*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<array<unsigned long,4> >","std::vector<std::array<unsigned long, 4ul>, std::allocator<std::array<unsigned long, 4ul> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<array<int,4> >*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<array<int,4> >","std::vector<std::array<int, 4ul>, std::allocator<std::array<int, 4ul> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<array<array<TH1*,2>,64> >*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<array<array<TH1*,2>,64> >","std::vector<std::array<std::array<TH1*, 2ul>, 64ul>, std::allocator<std::array<std::array<TH1*, 2ul>, 64ul> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaUnpackData>*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<AidaUnpackData>","std::vector<AidaUnpackData, std::allocator<AidaUnpackData> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaScaler>*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<AidaScaler>","std::vector<AidaScaler, std::allocator<AidaScaler> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaPauseResume>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<AidaPauseResume>", -2, "vector", 214,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaHit>*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<AidaHit>","std::vector<AidaHit, std::allocator<AidaHit> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaEvent>*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<AidaEvent>","std::vector<AidaEvent, std::allocator<AidaEvent> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<AidaAnlData>*)
   {
      ...
      ::ROOT::AddClassAlternate("vector<AidaAnlData>","std::vector<AidaAnlData, std::allocator<AidaAnlData> >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const multimap<long,AidaHitPID>*)
   {
      ...
      ::ROOT::AddClassAlternate("multimap<long,AidaHitPID>","std::multimap<long, AidaHitPID, std::less<long>, std::allocator<std::pair<long const, AidaHitPID> > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<int,deque<int> >*)
   {
      ...
      ::ROOT::AddClassAlternate("map<int,deque<int> >","std::map<int, std::deque<int, std::allocator<int> >, std::less<int>, std::allocator<std::pair<int const, std::deque<int, std::allocator<int> > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
"/cvmfs/eel.gsi.de/debian8-x86_64/go4/602-00/include",
"/cvmfs/eel.gsi.de/debian8-x86_64/go4/602-00",
"/cvmfs/eel.gsi.de/debian8-x86_64/root/622-08/include/",
"/u/despec/DESPEC_S450_MAIN/",
0
    };
...
class __attribute__((annotate("$clingAutoload$AIDA_Decay_Event_Store.h")))  __attribute__((annotate("$clingAutoload$./FRS_Detector_System.h")))  AidaPauseResume;

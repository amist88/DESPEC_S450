...
//       std::vector<std::vector<TH1*>> hA_FRS_ZAoQ_implants_e_gate;
     ...
     // std::vector<TH2*> hA_FRS_Z1Z2_x2AoQ_implants_e_xy;
      ...
      TH2 *hA_FRS_ZAoQ_GeEvsT_all_mhtdc;
      TH1 *hA_FRS_ZAoQ_GeE[MAX_FRS_GATE];
      TH1 *hA_FRS_ZAoQ_GeE_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_ZAoQ_GeEvsT[MAX_FRS_GATE];
      TH2 *hA_FRS_ZAoQ_GeEvsT_mhtdc[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_GeE[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_GeE_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_GeEvsT_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_GeEvsT[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_X2AoQ_GeE[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_X2AoQ_GeE_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeEvsT[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeEvsT_mhtdc[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_X4AoQ_GeE[MAX_FRS_GATE];
      TH1 *hA_FRS_Z1Z2_X4AoQ_GeE_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeEvsT[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeEvsT_mhtdc[MAX_FRS_GATE];
     // TH2 *hA_FRS_GeEvsT;
      
      TH2 *hA_FRS_ZAoQ_GeE1_GeE2[MAX_FRS_GATE];
      TH2 *hA_FRS_ZAoQ_GeE1_GeE2_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_GeE1_GeE2[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_GeE1_GeE2_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeE1_GeE2[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X2AoQ_GeE1_GeE2_mhtdc[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeE1_GeE2[MAX_FRS_GATE];
      TH2 *hA_FRS_Z1Z2_X4AoQ_GeE1_GeE2_mhtdc[MAX_FRS_GATE];

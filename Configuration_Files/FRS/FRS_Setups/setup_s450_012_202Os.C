...
void setup_s450_012_202Os()
{
 ...
 /*
  ...
  frs->rho0[1]   = 1.; //S2-S4
  frs->rho0[2]   = 1.; //S4-S8
  frs->dispersion[0]    = -6.287; // BARB 2021-June, 1.5m version
  frs->dispersion[1]    =  7.981; // BARB 2021-June, 1.5m version
  frs->magnification[1] =  1.268; // BARB 2021-June, 1.5m version
  ...
  //frs->dist_SC21  = 1600.0; //just guess value by eye, need measured numbers !!
  //frs->dist_SC22  = 4100.0; //just guess value by eye, need measured numbers !!
  frs->dist_TPC21 =  604.0; // not used
  frs->dist_TPC22 = 1782.5; //not used
  //frs->dist_TPC23 = 1500.0; //just guess value by eye, need measured numbers !!
  //frs->dist_TPC24 = 4000.0; //just guess value by eye, need measured value !!
  ...
  //S4 2022-May05
  frs->dist_SC41    = 2160.0; // S450, 2022-May05
  frs->dist_SC42    = 2670.0; // S450, 2022-May05
  frs->dist_SC43    = 4706.0; // not installed
  frs->dist_MUSIC41 = 715.0;  // S450, 2022-May05
  frs->dist_MUSIC42 = 1225.0; // S450, 2022-May05
  frs->dist_MUSIC43 = 4895.0; // not installed
  frs->dist_TPC41   =  345.0; // S450, 2022-May05
  frs->dist_TPC42   = 1575.0; // S450, 2022-May05
  ...
  frs->bfield[2] = 9.7927;//202Os //  Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. preparing for S450
  frs->bfield[3] = 9.7927;//202Os //  Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. preparing for S450
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->vftx_length_2141 = 36.0; // SCI 21-41 
  id->vftx_length_2241 = 34.0; // SCI 22-41 
  id->vftx_length_2142 = 37.0; // SCI 21-42
  ...
  // MHTDCAnalysis S2-S4
  id->mhtdc_length_s2s4 = 36; // SCI 21-41 s533 16^O^8+ meter!!!!
  //id->mhtdc_length_sc2241 = 34; // SCI 22-41 s526 107Ag
...
// MUSIC41 velocity 12.05.2022 208Pb,file 126-129 
/*  id->vel_a[0] =   22323.1; //  MUSIC41 velocity corr. 
  id->vel_a[1] =   -58332.7;   // 
  id->vel_a[2] =   58130.4; // 
  id->vel_a[3] =   -20454.9;
*/
// MUSIC42 velocity 12.05.2022 208Pb
  ...
  // id->vel_a[0] =   6459.55; //  MUSIC41 velocity corr. 
  //id->vel_a[1] =  -11135.1;   // 
  //id->vel_a[2] =   5581.45; // 
  // id->vel_a[3] =   0.0;

// MUSIC42 velocity 12.05.22 Pb s450, file 126-129
  /*id->vel_a2[0] =  24641.2; 
  id->vel_a2[1] = -65514.8;
  id->vel_a2[2] =  64976.2;
  id->vel_a2[3] =  -22491.9;
 ...
 //TOF_SC41_SC21_TAC 12.05.22 Pb s450, beta 0.74 to 0.87, 5 points 
  ...
  //TOF_SC41_SC21_TAC 12.05.22 Pb s450, beta 0.74 to 0.87, 5 points 
  //id->id_tofoff2 =  198471.7; // offset (ps)
  //id->id_path2   =  123258.2; // path/c (ps)

  //TOF_SC41_SC21_TAC 12.05.22 Pb s450, 0.74 to 0.87, 4 points without 0.76  
  //id->id_tofoff2 =  198209.7;  // offset (ps)
  //id->id_path2   =  123032.1;  // path/c (ps)

  //TOF_SC41_SC21_TAC 12.05.22 Pb s450, beta 0.82 to 0.87, 3 points
  //id->id_tofoff2 =  200211.2;  // offset (ps)
  //id->id_path2   =  124736.3;  // path/c (ps)
  ...
  tpc->lim_dt[2][0][0] = 26000.;  tpc->lim_dt[2][0][1] = 60000.0; //A11 drift time TDC cut
  tpc->lim_dt[2][1][0] = 26000.;  tpc->lim_dt[2][1][1] = 60000.0; //A12 drift time TDC cut
  tpc->lim_dt[2][2][0] = 26000.;  tpc->lim_dt[2][2][1] = 60000.0; //A21 drift time TDC cut
  tpc->lim_dt[2][3][0] = 26000.;  tpc->lim_dt[2][3][1] = 60000.0; //A22 drift time TDC cut
  tpc->lim_lt[2][0][0] = 26000.;  tpc->lim_lt[2][0][1] = 60000.0; //DL1 time TDC cut
  tpc->lim_rt[2][0][0] = 26000.;  tpc->lim_rt[2][0][1] = 60000.0; //DR1 time TDC cut
  tpc->lim_lt[2][1][0] = 26000.;  tpc->lim_lt[2][1][1] = 60000.0; //DL2 time TDC cut
  tpc->lim_rt[2][1][0] = 26000.;  tpc->lim_rt[2][1][1] = 60000.0; //DL2 time TDC cut
  tpc->lim_csum1[2][0] = 14000.0;   tpc->lim_csum1[2][1] = 14600.0; //
  tpc->lim_csum2[2][0] = 14200.0;   tpc->lim_csum2[2][1] = 14600.0;
  tpc->lim_csum3[2][0] = 14200.0;   tpc->lim_csum3[2][1] = 14460.0;
  tpc->lim_csum4[2][0] = 14250.0;   tpc->lim_csum4[2][1] = 14460.0;
  ...
  tpc->lim_dt[3][0][0] = 26000.;  tpc->lim_dt[3][0][1] = 60000.0; //A11 drift time TDC cut
  tpc->lim_dt[3][1][0] = 26000.;  tpc->lim_dt[3][1][1] = 60000.0; //A12 drift time TDC cut
  tpc->lim_dt[3][2][0] = 26000.;  tpc->lim_dt[3][2][1] = 60000.0; //A21 drift time TDC cut
  tpc->lim_dt[3][3][0] = 26000.;  tpc->lim_dt[3][3][1] = 60000.0; //A22 drift time TDC cut
  tpc->lim_lt[3][0][0] = 26000.;  tpc->lim_lt[3][0][1] = 60000.0; //DL1 time TDC cut
  tpc->lim_rt[3][0][0] = 26000.;  tpc->lim_rt[3][0][1] = 60000.0; //DR1 time TDC cut
  tpc->lim_lt[3][1][0] = 26000.;  tpc->lim_lt[3][1][1] = 60000.0; //DL2 time TDC cut
  tpc->lim_rt[3][1][0] = 26000.;  tpc->lim_rt[3][1][1] = 60000.0; //DL2 time TDC cut
  tpc->lim_csum1[3][0] = 18100.0;    tpc->lim_csum1[3][1] = 18800.0; //
  tpc->lim_csum2[3][0] = 17900.0;    tpc->lim_csum2[3][1] = 18700.0;
  tpc->lim_csum3[3][0] = 18600.0;    tpc->lim_csum3[3][1] = 19400.0; //
  tpc->lim_csum4[3][0] = 18200.0;    tpc->lim_csum4[3][1] = 19000.0;
...
//  sci->re_a[0][2] = 0.0;
  ...
  // sci->x_a[0][3] =  -2406.85;  // quickly done for s526 on 02.06.2021 (from online)
  //sci->x_a[1][3] =  5.33974;  //quickly done for s526 on 02.06.2021 (from online)
  //sci->x_a[2][3] =  -0.00368308;  // quickly done for s526 on 02.06.2021 (from online)
  //sci->x_a[3][3] =  8.02464e-7;  // quickly done for s526 on 02.06.2021 (from online)
...
//  sci->re_a[1][12] = 1.0;
  ...
  //s526, tac range 85ns 31.Mar.2021 
  //sci->tac_factor[2]  = 18.7611; //SC41L-SC21L [ps/ch] >> ch5 of ADC   
  //sci->tac_factor[3]  = 18.5460; //SC41R-SC21R [ps/ch] >> ch6 of ADC
  //sci->tac_factor[12] = 17.2487; //SC41L-SC22L [ps/ch] >> ch12
  //sci->tac_factor[13] = 18.4636; //SC41R-SC22R [ps/ch] >> ch13
  //sci->tac_factor[5]  = 18.3183; //SC42L-SC21L [ps/ch] >> ch8 of ADC
  //sci->tac_factor[6]  = 18.3585; //SC42R-SC21R [ps/ch] >> ch7 of ADC
  ...
  // for VFTX
  sci->vftx_offset_2141  =  -204.0; //ns test pulse simulating 150 ns TOF
  sci->vftx_offset_2241  =  -160.0 + 6.0; //ns test pulse simulating 150 ns TOF
  sci->vftx_offset_2142  =  -204.0 + 3.0 + 6.0; //ns test pulse simulating 150 ns TOF
...
//  sci->vftx_offset_228  =  -170.2; //ns // DUMMY needs calibration
  ...
  sci->mhtdc_offset_41_21  =  180.0 ; //ns //s533 16^O
  sci->mhtdc_offset_42_21  =  180.0; //ns // s452 Pb 210311
  sci->mhtdc_offset_43_21  =  0.0; //ns
  sci->mhtdc_offset_31_21  =  0.0; //ns
  sci->mhtdc_offset_81_21  =  -400.0 + 165.214; //ns
  sci->mhtdc_offset_41_22  =  255.0; //ns //s526 107Ag
  //sci->mhtdc_offset_M01_21  =  -543.38095 + (681.88795 - 628.5); //ns 08.09.2021

...
//     cInput->pFRS_x2AoQ_pass=true;
 ...
 void EventCorrelProc::Make_Timemachine_Histos(){
     ...
     hGe_TMdT= MakeTH1('I',"TimeMachine/Systems_dT/Ge_FEBEX_TimeMachinedT","Germanium FEBEX TM Ch.1 -Ch.2 ",400,-2000,2000);
 ...
 void EventCorrelProc::Make_FRS_AIDA_Histos(){
     ...
     for (int i = 0; i < conf->DSSDs(); ++i)
  {
        ...
        hA_FRS_ZAoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_XY_Z1vsAoQ_Gate%d", gate,i+1,gate), Form("DSSD %d implant hit pattern FRS Z1vsAoQ Gate%d", i+1,gate), xstrips, 0, ystrips, ystrips, 0, ystrips, "X strip", "Y strip");

        hA_FRS_ZAoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_Position/DSSD%d_implant_Position_Z1vsAoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z vs AoQ Gate %d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");
        ...
        hA_FRS_ZAoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_XY_Z1vsAoQ_Gate%d",gate, i+1,gate), Form("DSSD %d stopped implant hit pattern FRS Z1vsAoQ Gate%d", i+1,gate), xstrips, 0, ystrips, ystrips, 0, ystrips, "X strip", "Y strip");

        hA_FRS_ZAoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsAoQ/Z1vsAoQ_Gate%d/DSSD_Position/DSSD%d_implant_stopped_Position_Z1vsAoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z vs AoQ Gate%d ", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");
        ...
        hA_FRS_Z1Z2_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_XY/DSSD%d_implants_strip_XY_Z1Z2g%d", gate,i+1,gate), Form("DSSD %d implant hit pattern, FRS Z1 Z2 Gate %d", i+1,gate), xstrips, 0, xstrips, ystrips, 0, ystrips, "X strip", "Y strip");

        hA_FRS_Z1Z2_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_Position/DSSD%d_implant_Position_Z1vsZ2_Gate%d", gate, i+1,gate), Form("DSSD %d implant position FRS Z1 Z2 gate %d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");

        hA_FRS_Z1Z2_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_XY_Z1Z2g%d", gate,i+1,gate), Form("DSSD %d implant hit pattern, FRS Z1 Z2 Gate %d", i+1,gate), xstrips, 0, xstrips, ystrips, 0, ystrips, "X strip", "Y strip");

        hA_FRS_Z1Z2_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1vsZ2/Z1vsZ2_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1vsZ2_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1 Z2 Gate%d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");


        ///Z1Z2 X2AoQ
        hA_FRS_Z1Z2_x2AoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x2AoQ_Gate Gate%d", i+1,gate), xstrips, 0, ystrips, ystrips, 0, ystrips, "X strip", "Y strip");
        ...
        hA_FRS_Z1Z2_x2AoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x2AoQ/DSSD_Position/Z1Z2_x2AoQ_Gate%d/DSSD_Position/DSSD%d_implants_Position_Z1Z2_x2AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z1Z2_x2AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");

        hA_FRS_Z1Z2_x2AoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1Z2_x2AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1Z2_x2AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");

        hA_FRS_Z1Z2_x2AoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x2AoQ/Z1Z2_x2AoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_Z1Z2_x2AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x2AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, ystrips, 0, ystrips, "X strip", "Y strip");
        ...
        ///Z1Z2 X4AoQ
        hA_FRS_Z1Z2_x4AoQ_implants_strip_xy[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_XY/DSSD%d_implants_strip_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x4AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, ystrips, 0, ystrips, "X strip", "Y strip");
        ...
        hA_FRS_Z1Z2_x4AoQ_implants_position[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/All/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_Position/DSSD%d_implants_Position_Z1Z2_x4AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant position Z1Z2_x4AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");

        hA_FRS_Z1Z2_x4AoQ_implants_position_stopped[gate][i] = MakeTH2('D', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_Position/DSSD%d_implants_stopped_Position_Z1Z2_x4AoQ_Gate%d", gate, i+1,gate), Form("DSSD %d implant stopped position Z1Z2_x4AoQ Gate%d", i+1,gate), xstrips, -xmax, xmax, ystrips, -ymax, ymax, "X position/mm", "Y position/mm");

        hA_FRS_Z1Z2_x4AoQ_implants_strip_xy_stopped[gate][i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Stopped/Z1Z2_x4AoQ/Z1Z2_x4AoQ_Gate%d/DSSD_XY/DSSD%d_implants_stopped_strip_Z1Z2_x4AoQ_Gate%d",gate, i+1,gate), Form("DSSD %d implant hit pattern FRS Z1Z2_x4AoQ_Gate Gate%d", i+1,gate), xstrips, 0, xstrips, ystrips, 0, ystrips, "X strip", "Y strip");
...
//
      ...
      /* // hA_FRS_ZAoQ_implants_e_xy[i] = MakeTH2('F', Form("Correlations/AIDA-FRS/Implants/Z1Z2_x2AoQ_Gate/DSSD%d_implants_energy_XY_Z1Z2IDx2AoQg", i+1), Form("DSSD %d implant front energy vs back energy FRS Z1 Z2, and X2AoQ or X4AoQ And ZAoQ gated", i+1), 1000, 0, 10000, 1000, 0, 10000, "X Energy", "Y Energy");
        ...
        *///hA_FRS_ZAoQ_implants_strip_xy_dssdg[i] = MakeTH2('I', Form("Correlations/AIDA-FRS/Implants/Z1Z2_x2AoQ_Gate/DSSD%d_implants_strip_XY_Z1Z2IDx2AoQg_DSSDGate", i+1), Form("DSSD %d implant hit pattern FRS Z1 Z2, and X2AoQ or X4AoQ gated, DSSD Ion gate", i+1), xstrips, 0, xstrips, xstrips, 0, xstrips, "X strip", "Y strip");
    }
       ...
       if(cInputMain->pGe_T_Aligned[g][h]>0 && cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]>0){
        ...
        if(cInputMain->pGe_T_Aligned[g][h]!=0 && cInputMain->pGe_T_Aligned[Germanium_SC41_Det][Germanium_SC41L_Crystal_Digi]!=0){
              ...
              if(cInputMain->pFRS_ZAoQ_pass[gate]==true ){
                  ...
                  hA_FRS_ZAoQ_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                  hA_FRS_ZAoQ_GeEvsT[gate]->Fill(dT_Ge_SCI,cInputMain->pGe_E[g][h]);
                                    }

              if(cInputMain->pFRS_Z_Z2_pass[gate]==true){
                   ///Z1Z2 gated
                  hA_FRS_Z1Z2_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                  hA_FRS_Z1Z2_GeEvsT[gate]->Fill(dT_Ge_SCI,cInputMain->pGe_E[g][h]);
               ...
               ///Z1Z2 X2 AoQ gated
                if(cInputMain->pFRS_x2AoQ_pass[gate]==true ){
                    ...
                    hA_FRS_Z1Z2_X2AoQ_GeEvsT[gate]->Fill(dT_Ge_SCI,cInputMain->pGe_E[g][h]);
                            }

                ///Z1Z2 X4 AoQ gated
                if(cInputMain->pFRS_x4AoQ_pass[gate]==true){
                    hA_FRS_Z1Z2_X4AoQ_GeE[gate]->Fill(cInputMain->pGe_E[g][h]);
                    hA_FRS_Z1Z2_X4AoQ_GeEvsT[gate]->Fill(dT_Ge_SCI,cInputMain->pGe_E[g][h]);
                                    }
